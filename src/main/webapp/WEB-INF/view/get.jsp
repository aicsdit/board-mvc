	...
	<form action="updateForm.do" method="post">
		...
		<table class="table table-striped table-hover">
			<tr>
				...
				<th>subject</th><td><input type="text" value="${dto.subject}" name="subject" readonly></td>
			</tr>
			<tr>
				<th>content</th>
				<td colspan="3"><textarea rows="10" cols="80" name="content" readonly>${dto.content}</textarea></td>	
			</tr>
			<tr>
				<th>writer</th><td><input type="text" value="${dto.writer}" name="writer" readonly></td>
				<th>regDate</th><td><input type="text" value="${dto.regDate}" name="regDate" readonly></td>
			</tr>
			<tr>
				<td colspan="4">
